...
function schemaMigrations(migrationSpec) {
  var migrations = migrationSpec.migrations;
  if (process.env.NODE_ENV !== 'production') {
    ...
    migrations.forEach(function (migration) {
      ...
      (0, _invariant["default"])(typeof toVersion === 'number', 'Invalid migration - `toVersion` must be a number');
      (0, _invariant["default"])(toVersion >= 2, "Invalid migration to version ".concat(toVersion, ". Minimum possible migration version is 2"));
  ...
  var maxVersion = (newestMigration === null || newestMigration === void 0 ? void 0 : newestMigration.toVersion) || 1;
  if (process.env.NODE_ENV !== 'production') {
...
function unsafeExecuteSql(sql) {
  if (process.env.NODE_ENV !== 'production') {
    (0, _invariant["default"])(typeof sql === 'string', "SQL passed to unsafeExecuteSql is not a string");
