...
function checkName(name) {
  ...
  (0, _invariant["default"])(typeof name === 'string', "Unsafe name '".concat(name, "' not allowed (not a string)"));
  ...
  (0, _invariant["default"])(name.toLowerCase() !== '$loki', "Unsafe name '".concat(name, "' not allowed (reserved for LokiJS compatibility)"));
