...
function withRecreatedIndices(operations, schema) {
  ...
  var toEncodedOperations = function toEncodedOperations(sqlStr) {
...
function encodeBatch(operations, schema) {
  var nativeOperations = groupOperations(operations).map(function (_ref) {
    var _ref2 = (0, _slicedToArray2["default"])(_ref, 3),
      type = _ref2[0],
      table = _ref2[1],
      recordsOrIds = _ref2[2];
