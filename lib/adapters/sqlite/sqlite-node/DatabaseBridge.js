...
var DatabaseBridge = /*#__PURE__*/function () {
  ...
  _proto.connectDriverAsync = function connectDriverAsync(tag, driver) {
    var _this$connections$tag = this.connections[tag].queue,
      queue = _this$connections$tag === void 0 ? [] : _this$connections$tag;
    this.connections[tag] = {
      driver: driver,
      queue: [],
      status: 'connected'
  ...
  _proto.disconnectDriver = function disconnectDriver(tag) {
    var _this$connections$tag2 = this.connections[tag].queue,
      queue = _this$connections$tag2 === void 0 ? [] : _this$connections$tag2;
