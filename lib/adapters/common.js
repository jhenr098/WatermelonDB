...
function sanitizeFindResult(dirtyRecord, tableSchema) {
  return dirtyRecord && (0, _typeof2["default"])(dirtyRecord) === 'object' ? (0, _RawRecord.sanitizedRaw)(dirtyRecord, tableSchema) : dirtyRecord;
}
