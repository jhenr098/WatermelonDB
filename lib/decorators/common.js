...
function ensureDecoratorUsedProperly(columnName, target, key, descriptor) {
  ...
  if (descriptor) {
    ...
    (0, _invariant["default"])(typeof descriptor.initializer !== 'function', "Model field decorators must not be used on properties with a default value - error in \"".concat(target.constructor.name, ".prototype.").concat(key, "\"."));
  }
}