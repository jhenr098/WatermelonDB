...
var jsonDecorator = exports.jsonDecorator = function jsonDecorator(rawFieldName, sanitizer) {
  ...
  return function (target, key, descriptor) {
    ...
    return {
      ...
      set: function set(json) {
        ...
        var stringifiedValue = sanitizedValue != null ? JSON.stringify(sanitizedValue) : null;
