...
exports.naughtyMatchTests = exports.matchTests = exports.joinTests = void 0;
var _naughtyStrings = _interopRequireDefault(require("./utils/naughtyStrings"));
var QueryBuilders = _interopRequireWildcard(require("../QueryDescription"));
...
var Q = QueryBuilders;
var matchTests = exports.matchTests = [];
...
matchTest({
  ...
  query: [Q.where('text1', "value1"), Q.where('num1', 2), Q.where('bool1', true), Q.where('bool2', false), Q.where('float1', null)],
  matching: [{
    id: 'm1',
    text1: 'value1',
    num1: 2,
...
matchTest({
  ...
  query: [Q.where('text1', 'value'), Q.or(Q.where('bool1', true), Q.where('text2', null), Q.and(Q.where('float1', Q.gt(5)), Q.where('float2', Q.notIn([6, 7]))))],
  matching: [{
    id: 'm1',
    text1: 'value',
    bool1: true,
...
matchTest({
  ...
  nonMatching: [{
    ...
    id: 'n2',
    text1: 'Vestibulum eget felis commodo, gravida velit nec, congue lorem.'
  }, {
    id: 'n3',
    text1: 'Integer accumsan tincidunt velit, eu fermentum lorem mollis at.'
  }, {
    id: 'n4',
...
matchTest({
  ...
  matching: [{
    ...
    id: 'm2',
    text1: 'Vestibulum eget felis commodo, gravida velit nec, congue\n\nLorem'
  }],
  nonMatching: [{
    id: 'n1',
    text1: 'Lorem Ipsum dolor sit amet,'
    ...
    id: 'n5',
    text1: 'Integer accumsan tincidunt velit, lorem\neu fermentum lorem mollis at.'
  }, {
    id: 'nZ',
    text1: null
  }]
...
matchTest({
  ...
  matching: [{
    ...
    id: 'm3',
    text1: 'Larem Ipsum dolor sit amet, consectetur adipiscing epit.'
  }],
  nonMatching: [{
    id: 'n1',
    text1: 'Lorem Ipsum dolor sit amet,'
...
matchTest({
  name: 'matches like sanitized (%(value,)%)',
  query: [Q.where('text1', Q.like("%".concat(Q.sanitizeLikeString('commodo,'), "%")))],
  matching: [{
    id: 'm1',
    text1: 'Vestibulum eget felis commodo, gravida velit nec, congue lorem'
  }, {
...
matchTest({
  ...
  query: [Q.where('text1', Q.includes(""))],
  // weird edge case
  matching: [{
    id: 'm0',
    text1: ''
...
matchTest({
  ...
  query: [Q.unsafeSqlQuery('select * from tasks where num1 not between ? and ? and num2 is not ? and text1 is ? and bool1 is ? and text2 is ?', [1, 5, 3.14, 'hi', true, null])],
  matching: [{
    id: 'm1',
    text1: 'hi',
    bool1: true,
...
matchTest({
  ...
  query: [Q.unsafeSqlQuery('select count(*) as count from tasks where num1 not between ? and ? and num2 is not ? and text1 is ? and bool1 is ? and text2 is ?', [1, 5, 3.14, 'hi', true, null])],
  matching: [{
    id: 'm1',
    text1: 'hi',
    bool1: true,
...
var naughtyMatchTests = exports.naughtyMatchTests = _naughtyStrings["default"].map(function (naughtyString) {
  return {
    name: naughtyString,
    ...
    nonMatching: [{
      ...
      id: 'n2',
      text1: 'not-a-naughty-string'
    }]
  };
});
var joinTests = exports.joinTests = [];
...
joinTest({
  ...
  query: [Q.on('projects', 'text1', 'abcdef'), Q.where('text1', 'val1'), Q.on('tag_assignments', 'text1', Q.oneOf(['a', 'b', 'c'])), Q.on('projects', 'bool1', true)],
  extraRecords: {
    projects: [{
      id: 'p2',
      text1: 'abcdef',
...
joinTest({
  ...
  query: [Q.on('projects', [Q.where('text1', 'foo'), Q.or(Q.where('num1', 2137), Q.where('bool1', true))])],
  extraRecords: {
    projects: [{
      id: 'p1',
      text1: 'foo',
...
joinTest({
  ...
  query: [Q.experimentalJoinTables(['projects', 'tag_assignments']), Q.or(Q.where('bool1', true), Q.on('projects', 'bool1', true), Q.and(Q.on('tag_assignments', 'text1', 'foo')))],
  extraRecords: {
    projects: [{
      id: 'p1',
      bool1: true
...
joinTest({
  ...
  query: [Q.experimentalNestedJoin('projects', 'teams'), Q.on('projects', Q.on('teams', 'text1', 'bingo'))],
  extraRecords: {
    projects: [{
      id: 'p1',
      team_id: 't1'
...
joinTest({
  ...
  query: [Q.experimentalJoinTables(['projects']), Q.experimentalNestedJoin('projects', 'teams'), Q.experimentalNestedJoin('teams', 'organizations'), Q.or(Q.where('text1', 'BINGO'), Q.on('projects', Q.on('teams', [Q.where('bool1', true), Q.or(Q.where('text1', 'GUDTIM'), Q.on('organizations', 'num1', 2137))])))],
  extraRecords: {
    projects: [{
      id: 'p1',
      team_id: 't1'
    ...
    teams: [{
      ...
      id: 'badt4',
      bool1: true,
      organization_id: 'bado1'
    }, {
      id: 'badt5',
      bool1: true,
      organization_id: 'bado2'
    }],
    organizations: [{
      id: 'o1',
      num1: 2137
...
joinTest({
  ...
  query: [Q.where('text1', 'val1'), Q.on('projects', 'text1', 'val2'), Q.on('projects', 'text2', Q.eq(Q.column('text3')))],
  extraRecords: {
    projects: [{
      id: 'p1',
      text1: 'val2',
...
joinTest({
  ...
  query: [Q.experimentalJoinTables(['projects']), Q.experimentalNestedJoin('projects', 'teams'), Q.or(Q.on('projects', Q.on('teams', [Q.where('num1', Q.gt(Q.column('num2')))])))],
  extraRecords: {
    teams: [{
      id: 't1',
      num1: 10,
...
joinTest({
  ...
  query: [Q.experimentalJoinTables(['projects']), Q.unsafeSqlQuery("select tasks.* from tasks left join projects on tasks.project_id is projects.id where projects.num1 is not null and tasks.num1 > projects.num1 and tasks._status is not 'deleted' and projects._status is not 'deleted'")],
  extraRecords: {
    projects: [{
      id: 'p1',
      num1: 5
...
joinTest({
  ...
  query: [Q.on('projects', 'num1', Q.notEq(null)), Q.unsafeLokiTransform(function (raws, loki) {
    var newRaws = [];
    raws.forEach(function (raw) {
      var project = loki.getCollection('projects').by('id', raw.project_id);
